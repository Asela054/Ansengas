...
<!-- <div class="dropdown-user-details-name text-dark" style="margin-left:60rem; font-size:1rem;"><span id="currentDateTime"></span></div> -->
    <ul class="navbar-nav align-items-center ml-auto">
        <li class="nav-item dropdown no-caret mr-3 dropdown-user">
            <a class="btn btn-link"><h3 class="m-0" id="currentDateTime"></h3></a>
    ...
    <button id="birthdayAlertLink" class="btn btn-primary btn-sm">

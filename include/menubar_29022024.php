...
<nav class="sidenav shadow-right sidenav-light">
    <div class="sidenav-menu">
        <div class="nav accordion" id="accordionSidenav">
            ...
            <?php if(menucheck($menuprivilegearray, 9)==1 | menucheck($menuprivilegearray, 70)==1 | menucheck($menuprivilegearray, 8)==1){ ?>
            ...
            <?php } if(menucheck($menuprivilegearray, 4)==1 | menucheck($menuprivilegearray, 73)==1){ ?>
            ...
            <?php } if(menucheck($menuprivilegearray, 23)==1 | menucheck($menuprivilegearray, 24)==1 | menucheck($menuprivilegearray, 67)==1){ ?>
            ...
            <?php } if(menucheck($menuprivilegearray, 11)==1 | menucheck($menuprivilegearray, 12)==1 | menucheck($menuprivilegearray, 13)==1 | menucheck($menuprivilegearray, 68)==1 | menucheck($menuprivilegearray, 69)==1){ ?>

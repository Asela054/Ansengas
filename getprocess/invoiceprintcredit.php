...
<body>
    ...
    <div id='DivIdToPrint'>
        <table style="width:100%;">
            ...
            <tr>
                <td style="text-align: center; font-size:10px;" colspan="2"><span style="text-align: center; font-size:16px;font-weight: bold;">Thank You. Come again</span><br><i style="text-align: center; font-size:16px;" class='lab la-facebook'></i> Lionel Trade Center  / Copyright © ERav Technology</td>
            </tr>
        </table>
    </div>
    <!-- <p>Do not print.</p>

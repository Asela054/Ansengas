    ...
    <table class="table table-striped table-bordered table-sm text-center">
        ...
        <tbody>
            ...
            if($resultdaily->num_rows>0){while($rowdaily = $resultdaily-> fetch_assoc()){ 
                ...
                $sqlproductone="SELECT `newqty`, `refillqty`, `emptyqty` FROM `tbl_invoice_detail` WHERE `status`=1 AND `tbl_product_idtbl_product`='6' AND `tbl_invoice_idtbl_invoice`='$invoiceID'";
                $resultproductone =$conn-> query($sqlproductone);   
                $rowproductone = $resultproductone-> fetch_assoc();

                $sqlproducttwo="SELECT `newqty`, `refillqty`, `emptyqty` FROM `tbl_invoice_detail` WHERE `status`=1 AND `tbl_product_idtbl_product`='4' AND `tbl_invoice_idtbl_invoice`='$invoiceID'";
                $resultproducttwo =$conn-> query($sqlproducttwo);   
                $rowproducttwo = $resultproducttwo-> fetch_assoc();

                $sqlproductthree="SELECT `newqty`, `refillqty`, `emptyqty` FROM `tbl_invoice_detail` WHERE `status`=1 AND `tbl_product_idtbl_product`='1' AND `tbl_invoice_idtbl_invoice`='$invoiceID'";
                $resultproductthree =$conn-> query($sqlproductthree);   
                $rowproductthree = $resultproductthree-> fetch_assoc();

                $sqlproductfour="SELECT `newqty`, `refillqty`, `emptyqty` FROM `tbl_invoice_detail` WHERE `status`=1 AND `tbl_product_idtbl_product`='2' AND `tbl_invoice_idtbl_invoice`='$invoiceID'";
            ...
            <tr>
                ...
                <td nowrap><?php echo $rowproductone['refillqty']+$rowproductone['emptyqty']; $poneemptyqty=$poneemptyqty+$rowproductone['refillqty']+$rowproductone['emptyqty']; ?></td>
                ...
                <td nowrap><?php echo $rowproducttwo['refillqty']+$rowproducttwo['emptyqty']; $ptwoemptyqty=$ptwoemptyqty+$rowproducttwo['refillqty']+$rowproducttwo['emptyqty']; ?></td>
                ...
                <td nowrap><?php echo $rowproductthree['refillqty']+$rowproductthree['emptyqty']; $pthreeemptyqty=$pthreeemptyqty+$rowproductthree['refillqty']+$rowproductthree['emptyqty']; ?></td>
                ...
                <td nowrap><?php echo $rowproductfour['refillqty']+$rowproductfour['emptyqty']; $pfouremptyqty=$pfouremptyqty+$rowproductfour['refillqty']+$rowproductfour['emptyqty']; ?></td>
                <?php 
                ...
                <?php } ?>
                <td nowrap class="text-right"><?php echo number_format($rowdaily['nettotal'],2); $totalamount=$totalamount+$rowdaily['nettotal']; ?></td>
                ...
                <td nowrap class="text-right"><?php echo number_format(($rowdaily['nettotal']-($rowcash['amount']+$chequetotal)),2);  $totalcredit=$totalcredit+($rowdaily['nettotal']-($rowcash['amount']+$chequetotal)); ?></td>
                <td nowrap></td>
                <td nowrap></td>
            </tr>
            <?php } ?>
            ...
            <?php
            $actuallytotal=0;
            $sqlproductlist="SELECT `idtbl_product`, `product_name`, `newprice`, `refillprice`, `emptyprice` FROM `tbl_product` WHERE `status`=1 AND `tbl_product_category_idtbl_product_category`=1";
            ...
            while($rowproductlist = $resultproductlist-> fetch_assoc()){
                ...
                $refillqty=0;
                $trustqty=0;
                $sqlproductdetail="SELECT `newqty`, `refillqty`, `emptyqty`, `newprice`, `refillprice`, `emptyprice` FROM `tbl_invoice_detail` WHERE `status`=1 AND `tbl_product_idtbl_product`='$productID' AND `tbl_invoice_idtbl_invoice` IN (SELECT `idtbl_invoice` FROM `tbl_invoice` WHERE `date`='$validfrom' AND `status`=1)";
                $resultproductdetail =$conn-> query($sqlproductdetail);
                while($rowproductdetail = $resultproductdetail-> fetch_assoc()){
                    $newprice=$rowproductdetail['newqty']*$rowproductlist['newprice'];
                    $refillprice=$rowproductdetail['refillqty']*$rowproductlist['refillprice'];
                    $trustprice=$rowproductdetail['emptyqty']*$rowproductlist['emptyprice'];
                    ...
                    $trustqty=$trustqty+$rowproductdetail['emptyqty'];
            ...
            <tr>
                ...
                <td nowrap class="text-right"><?php echo number_format($rowproductlist['emptyprice'], 2) ?></td>
                <td nowrap>X</td>
            ...
            <tr>
                ...
                <td nowrap class="text-right"><?php echo number_format($rowproductlist['refillprice'], 2) ?></td>
                <td nowrap>X</td>

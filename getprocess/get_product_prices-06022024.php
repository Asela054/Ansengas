...
if ($specialStatus == 1) {
    $query = "SELECT p.idtbl_product, p.product_name, ap.newsaleprice, ap.refillsaleprice, ap.emptysaleprice, ap.encustomer_newprice, ap.encustomer_refillprice, ap.encustomer_emptyprice
              FROM tbl_product p 
              ...
              WHERE `ap`.`status` = 1 AND p.tbl_product_category_idtbl_product_category IN (1,2) AND sa.`idtbl_area` = '$mainArea' 

...
if($type==1){
    ...
    $sqlcustomer="SELECT `idtbl_customer`, `name`, `creditperiod`, `discount_status` FROM `tbl_customer` WHERE `status`=1 AND `idtbl_customer` IN (SELECT `tbl_customer_idtbl_customer` FROM `tbl_customerwise_salesrep` WHERE `status`=1 AND `tbl_employee_idtbl_employee`='$customer' GROUP BY `tbl_customer_idtbl_customer`)";
    $resultcustomer =$conn-> query($sqlcustomer);
}
else{
    $sqlcustomer="SELECT `idtbl_customer`, `name`, `creditperiod`, `discount_status` FROM `tbl_customer` WHERE `status`=1 ORDER BY `name` ASC";
...
<table class="table table-striped table-bordered sticky-header table-sm" id="tableoutstanding">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td colspan="9"><?php echo $rowcustomerrep['sales_reps']; ?></td>
        </tr>
        <?php 
        ...
        ?>
        <tr class="<?php if($rowinvoicelist['days_since_invoice']>=$rowcustomer['creditperiod']){echo 'table-danger';} ?>">
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            ...
            <td class="text-center"><?php echo $rowinvoicelist['remarks'] ?></td>
        </tr>
        <?php }}}} ?>
    </tbody>
    <tfoot>

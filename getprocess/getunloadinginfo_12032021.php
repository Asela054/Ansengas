        ...
        <table class="table table-striped table-bordered table-sm nowrap w-100" id="tableunloading">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center"><?php echo $rowinvoiceqty['newqty'] ?></td>
                    <td class="text-center"><?php echo $rowinvoiceqty['refillqty'] ?></td>
                    <td class="text-center"><?php echo $rowinvoiceqty['trustqty'] ?></td>
                    <td class="text-center"><?php echo $rowinvoiceqty['returnqty'] ?></td>

...
<table class="table table-striped table-bordered table-sm" id="tableproductlist">
    <thead>
        <tr>
            ...
            <th class="text-right">Refill Sale Price</th>
            <th>&nbsp;</th>
        </tr>
    </thead>
    <tbody>
        ...
        <tr>
            ...
            <td class="text-right"><?php echo number_format($row['newsaleprice'], 2) ?></td>
            <td class="text-right"><?php echo number_format($row['refillsaleprice'], 2) ?></td>

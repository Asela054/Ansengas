...
?>
    <tr>
        ...
        <td><?php echo $rowbal['accname']; ?></td>
        <td class="text-right <?php if($rowtotrecord['count']==$j && $subheadid!=20){echo 'sect_col';} ?>"><?php echo number_format($rowbal['accamount'], 2); ?></td>
        <th class="text-right <?php if($rowtotrecord['count']==$j && $subheadid==25){echo 'sect_col';} ?>"><?php if($rowtotrecord['count']==$j && $subheadid!=20){echo number_format($noncurrenttot,2); $totassets=$totassets+$noncurrenttot;} ?></th>
    </tr>
<?php 
    }
    if($subheadid==20 && $rowtotrecord['count']==$j){ 
        ...
        $noncurrenttot=$noncurrenttot+$rowclosestock['closingstock'];
?>
    <tr>
        <td class="pl-4"></td>
        <td>Closing Stock <?php echo $param_date_fr; ?></td>
        <td class="text-right sect_col"><?php echo number_format($rowclosestock['closingstock'], 2);  ?></td>
        <th class="text-right sect_col"><?php if($rowtotrecord['count']==$j){echo number_format($noncurrenttot,2); $totassets=$totassets+$noncurrenttot;} ?></th>
    </tr>

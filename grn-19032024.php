    ...
    function textremove(classname, row) {
        $('#tableGrnList tbody').on('keyup', classname, function(e) {
            if (e.keyCode === 13) { 
                ...
                var newqty = parseFloat(row.closest("tr").find('td:eq(8)').text());
                var refillqty = parseFloat(row.closest("tr").find('td:eq(9)').text());
                var emptyqty = parseFloat(row.closest("tr").find('td:eq(10)').text());
                var trustqty = parseFloat(row.closest("tr").find('td:eq(11)').text());
                var saftyqty = parseFloat(row.closest("tr").find('td:eq(12)').text());
                ...
                $('#tableGrnList').find('tr').eq(rowID).find('td:eq(13)').text(total);
                $('#tableGrnList').find('tr').eq(rowID).find('td:eq(14)').text(showtotal);

...
$sql="SELECT tt.idtbl_tank_transaction, tt.qty AS transaction_qty, COALESCE(SUM(ttr.qty), 0) AS return_qty, tt.collectstatus, tt.issuestatus, tt.collectdate, tt.issuedate, tt.status, tt.insertdatetime, tt.tbl_user_idtbl_user, tt.tbl_vehicle_load_idtbl_vehicle_load, tt.tbl_customer_idtbl_customer, tt.tbl_product_idtbl_product, c.name AS customer_name, p.product_name FROM tbl_tank_transaction tt LEFT JOIN tbl_tank_transaction_return ttr ON tt.idtbl_tank_transaction = ttr.tbl_tank_transaction_idtbl_tank_transaction LEFT JOIN tbl_customer c ON c.idtbl_customer = tt.tbl_customer_idtbl_customer LEFT JOIN tbl_product p ON p.idtbl_product = tt.tbl_product_idtbl_product WHERE tt.status IN (1, 2) GROUP BY tt.idtbl_tank_transaction, tt.qty, tt.collectstatus, tt.issuestatus, tt.collectdate, tt.issuedate, tt.status, tt.insertdatetime, tt.tbl_user_idtbl_user, tt.tbl_vehicle_load_idtbl_vehicle_load, tt.tbl_customer_idtbl_customer, tt.tbl_product_idtbl_product, c.name, p.product_name;";
                                        ...
                                        <div class="row">
                                            <div class="col-3">
                                                <form action="process/issuetankprocess.php" method="post"
                                                    ...
                                                    <div class="form-group mb-1">
                                                        <label class="small font-weight-bold text-dark">Returned Qty*</label>
                                                        <input type="text" class="form-control form-control-sm"
                                                            name="returnqty" id="returnqty" readonly>
                                                    </div>
                                                    <div class="form-group mb-1">
                                                        <label class="small font-weight-bold text-dark">Qty</label>
                                                        <input type="text" class="form-control form-control-sm"

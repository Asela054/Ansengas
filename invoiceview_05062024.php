        ...
        $('#dataTable').DataTable( {
            ...
            "columns": [
                ...
                },
                {
                    ...
                    "data": null,
                    "render": function(data, type, full) {
                        var balance = parseFloat(full['balance_amount']).toFixed(2);
                        if (balance < 0) {
                            return '0.00';
                        } else {
                            return addCommas(balance);
                        }
                    }
                },
                // {
                ...
                //     "data": null,
                //     "render": function(data, type, full) {
                //         var excessPayment = parseFloat(full['excess_payment']).toFixed(2);
                //         if (excessPayment < 0) {
                //             return '0.00';
                //         } else {
                //             return addCommas(excessPayment);
                //         }
                //     }
                // },
                {

...
if (isset($_POST["file_content"])) {
    $validfrom = $_POST['hidefrom'];
    $validto = $_POST['hideto'];
    ...
    $cleaned_html_content = cleanHTMLContent($_POST["file_content"]);

    file_put_contents($temporary_html_file, $cleaned_html_content);
    ...
    $filename = 'SalesRegisternonvat_'.$validfrom.'_'.$validto.'.xlsx';
...
header("Location:../exportaccounts.php");
?>
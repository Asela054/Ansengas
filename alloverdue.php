                                    ...
                                    <div class="form-row">
                                        <div class="col-3">
                                            ...
                                            <div class="input-group input-group-sm">
                                                <select class="form-control form-control-sm rounded-0" name="customer" id="customer" required>
                                        ...
                                        <div class="col-4">
                                            ...
                                            <button class="btn btn-outline-dark btn-sm rounded-0 px-4" type="button" id="formSearchBtn">
        ...
        $('#formSearchBtn').click(function(){
            if (!$("#searchform")[0].checkValidity()) {
                ...
                $.ajax({
                    ...
                    url: 'getprocess/getalloverduereport.php',

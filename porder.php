...
$sqlorder="SELECT `idtbl_porder_request` FROM `tbl_porder_request` WHERE `status`=1 AND `confirmstatus`=1";
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        <form id="createorderform" autocomplete="off">
                            <div class="form-row mb-1">
                                ...
                                <div class="col-3">
                                    <label class="small font-weight-bold text-dark">Purchase Order Request No.</label>
                                    <select name="ponumber" id="ponumber" class="form-control form-control-sm">
                                        ...
                                        <option value="<?php echo $roworder['idtbl_porder_request'] ?>"><?php echo 'POR-'.$roworder['idtbl_porder_request'] ?></option>
                                        <?php }} ?>
                                    </select>
                                </div>  
                            </div>

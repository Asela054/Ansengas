            ...
            "columns": [
                ...
                },
                {
                    ...
                    render: function (data, type, full) {
                        ...
                        switch (data) {
                            case 0:
                                return '<span class="badge bg-warning text-light px-3 py-2">Pending</span>';
                            case 1:
                                return '<span class="badge bg-success text-light px-3 py-2">Approved</span>';
                            default:
                                return '<span class="badge bg-secondary text-light px-3 py-2">Unknown</span>';
                        }
                    }
                },
                {

        ...
        $('#dataTable').DataTable( {
            ...
            "columns": [
                ...
                },
                {
                    ...
                    "render": function(data, type, full) {
                        var button='';
                        button+='<button class="btn btn-outline-dark btn-sm mr-1 btnView ';if(editcheck==0){button+='d-none';}button+='" data-toggle="tooltip" data-placement="bottom" title="View Order" id="'+full['idtbl_credit_note']+'"><i class="far fa-eye"></i></button>'; 

                        button+='<a href="process/statuscreditnote.php?record='+full['idtbl_credit_note']+'&type=3" onclick="return delete_confirm()" target="_self" class="btn btn-outline-danger btn-sm mr-1 ';if(statuscheck==0){button+='d-none';}button+='"><i class="far fa-trash-alt"></i></a>';
        ...
        $('#dataTable tbody').on('click', '.btnView', function() {
            ...
            $.ajax({
                ...
                success: function(result) { //alert(result);
                    ...
                    $('#tableorderview > tbody:last').append('<tr><td>' + objfirst[i].productname + '</td><td class="d-none">' + objfirst[i].productid + '</td><td class="text-center">' + objfirst[i].emptyqty + '</td><td class="text-right total">' + objfirst[i].total + '</td></tr>');
                    });

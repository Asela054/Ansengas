                ...
                <div class="container-fluid">
                    <div class="page-header-content py-3">
                        <h1 class="page-header-title">
                            ...
                            <span>Buffer Stock Maintainance</span>
                        </h1>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                            ...
                            <form id="searchform">
                                <div class="form-row">
                                    ...
                                    <div class="col-3">
                                        <label class="small font-weight-bold text-dark">Customer | Sales Excutive | Lorry | Driver</label>
...
<script>
    $(document).ready(function() {
        ...
        $('#btnconvert').click(function(){
            ...
            table_content += $('#bufferreport').html();
            table_content += '</table>';

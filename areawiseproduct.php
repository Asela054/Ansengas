                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <?php if($editcheck==1){ ?>
                                                ...
                                                <button data-url="process/statusareawiseproduct.php?record=<?php echo $row['idtbl_areawise_product'] ?>&type=2" data-actiontype="2" class="btn btn-outline-success btn-sm btntableaction"><i data-feather="check"></i></button>
                                                <?php } else if($statuscheck==1 && $row['status']==2){ ?>
                                                <button data-url="process/statusareawiseproduct.php?record=<?php echo $row['idtbl_areawise_product'] ?>&type=1" data-actiontype="1" class="btn btn-outline-warning btn-sm btntableaction"><i data-feather="x-square"></i></button>
                                                <?php } if($deletecheck==1){ ?>
                                                <button data-url="process/statusareawiseproduct.php?record=<?php echo $row['idtbl_areawise_product'] ?>&type=3" data-actiontype="3" class="btn btn-outline-danger btn-sm btntableaction"><i data-feather="trash-2"></i></button>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        <?php }} ?>

                ...
                success: function (data) {
                    ...
                    $.each(data, function (index, product) {
                        ...
                        tableBody.append('<tr class="' + categoryClass + '">' +
                            ...
                            '<td class="text-center">                            '<td class="text-center"><input type="text" class="input-integer form-control form-control-sm custom-width full-qty-input" name="full_quantity[]" value="0"></td>' +</td>' +
                            '</tr>');
                    });

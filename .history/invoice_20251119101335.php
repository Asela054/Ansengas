                                ...
                                <div class="card shadow-none border-0">
                                    <div id="collapseThree" class="collapse" aria-labelledby="headingThree"
                                        ...
                                        <div class="card-body p-0">
                                            ...
                                            <div class="form-group mb-1">
                                                <label class="small font-weight-bold text-dark">Cheque Date</label>
                                                <input type="date" class="form-control form-control-sm" placeholder="" name="paymentchequeDate2" id="paymentchequeDate2" readonly>
                                            </div>
                                            <div class="form-group mb-1">
                                                <label class="small font-weight-bold text-dark">Bank Name</label>
...
<script>
    ...
    // });
    $(document).ready(function() {
        $('#modalpaymentreceipt').on('hide.bs.modal', function () {
        ...
        $("#customer").change(function () {
            ...
            if (cid !== "") {
                ...
                $.ajax({
                    url: "getprocess/get_customer_status.php",
                    type: "POST",
        ...
        //                 var avaqtyinfo = fetchAvailableQuantity(loadID, product.idtbl_product);
        //                 console.log(avaqtyinfo);
        ...
        //                 //         $('#vatamount').val(availability.vatamount);
        ...
        //                 //             $('.input-integer').on('focus', function() {
        //                 //                 if ($(this).val() === '0') {
        //                 //                     $(this).select();
        //                 //                 }
        //                 //             });
        ...
        $('#customer').change(async function () {
            var customerID = $(this).val();
            var loadID = $('#vehicleload').val();
            var areaID = $('#area').val();
            ...
            try {
                ...
                for (const product of data) {
                    try {
                        const avaqtyinfo = await fetchAvailableQuantity(loadID, product.idtbl_product);
                        // console.log(avaqtyinfo);

                        if (avaqtyinfo.avaqty !== null && avaqtyinfo.avaqty !== undefined && avaqtyinfo.avaqty !== '') {
                            var newsalepricewithVAT = (parseFloat(product.newsaleprice) || 0) * (1 + avaqtyinfo.vatamount / 100);
                            var refillsalepricewithVAT = (parseFloat(product.refillsaleprice) || 0) * (1 + avaqtyinfo.vatamount / 100);
                            var emptysalepricewithVAT = (parseFloat(product.emptysaleprice) || 0) * (1 + avaqtyinfo.vatamount / 100);
                            var encustomer_newprice_withVAT = (parseFloat(product.encustomer_newprice) || 0) * (1 + avaqtyinfo.vatamount / 100);
                            var encustomer_refillprice_withVAT = (parseFloat(product.encustomer_refillprice) || 0) * (1 + avaqtyinfo.vatamount / 100);
                            var encustomer_emptyprice_withVAT = (parseFloat(product.encustomer_emptyprice) || 0) * (1 + avaqtyinfo.vatamount / 100);

                            $('#vatamount').val(avaqtyinfo.vatamount);
                            ...
                            tableBody.append('<tr>' +
                                ...
                                '<td class="text-left">' + addCommas(parseFloat(product.encustomer_refillprice).toFixed(2)) + '</td>'+
                                '<td class="text-left">' + addCommas(parseFloat(product.encustomer_emptyprice).toFixed(2)) + '</td>' +
                                '<td class="text-center"><input type="number" class="form-control form-control-sm custom-width ' + (avaqtyinfo.avaqty == 0 ? 'bg-danger-soft' : '') + '" name="available_quantity[]" id="avaqty" value="' + avaqtyinfo.avaqty + '" readonly></td>'+
                                '<td class="text-center"><input type="number" class="form-control form-control-sm custom-width  ' + (avaqtyinfo.emptyqty == 0 ? 'bg-danger-soft' : '') + '" name="ava_empty_quantity[]" id="avaqty" value="' + avaqtyinfo.emptyqty + '" readonly></td>' +
                                '<td class="text-center"><input type="text" class="input-integer form-control form-control-sm custom-width" name="new_quantity[]" value="0"></td>' +
                                '<td class="text-center"><input type="text" class="input-integer form-control form-control-sm custom-width" name="refill_quantity[]" value="0" ' + (parseInt(product.tbl_product_category_idtbl_product_category) === 2 ? 'readonly' : '') + '></td>' +
                                '<td class="text-center"><input type="text" class="input-integer form-control form-control-sm custom-width" name="empty_quantity[]" value="0" ' + (parseInt(product.tbl_product_category_idtbl_product_category) === 2 ? 'readonly' : '') + '></td>' +
                                '<td class="text-center"><input type="text" class="input-integer form-control form-control-sm custom-width" name="trust_quantity[]" value="0" ' + (parseInt(product.tbl_product_category_idtbl_product_category) === 2 ? 'readonly' : '') + '></td>' +
                                '<td class="text-center"><input type="text" class="input-integer form-control form-control-sm custom-width" name="trust_return_quantity[]" value="0" ' + (parseInt(product.tbl_product_category_idtbl_product_category) === 2 ? 'readonly' : '') + '></td>' +
                                '<td class="d-none hide-total-column"><input type="text" class="form-control form-control-sm custom-width" name="hidetotal_quantity[]" value="0"></td>' +
                                '<td class="text-center"><input type="text" class="form-control form-control-sm custom-width" name="vat_amount[]" id="vat_amount" value="' + avaqtyinfo.vatamount + '%" readonly></td>' +
                                '<td class="text-right total-column"><input type="text" class="form-control form-control-sm custom-width" name="total_quantity[]" value="0" readonly></td>' +
                                '<td class="d-none hide-total-column_without_VAT"><input type="number" class="form-control form-control-sm custom-width" name="hidetotal_quantity_without_VAT[]" value="0"></td>' +
                                '<td class="d-none">' + (product.discount_price || 0) + '</td>' +
                                '</tr>');
        ...
        $("#submitBtnModal").click(function() {
            if (!$("#formModal")[0].checkValidity()) {
                ...
                if(paymenttype==1){
                    $('#tblPaymentTypeModal > tbody:last').append('<tr><td>Cash</td><td class="text-right total">' + parseFloat(paymentCash).toFixed(2) + '</td><td class="">-</td><td class="">-</td><td>-</td><td>-</td><td>-</td><td class="d-none">0</td><td class="d-none">1</td></tr>');
                }
                else if(paymenttype==2){
                    $('#tblPaymentTypeModal > tbody:last').append('<tr><td>Bank / Cheque</td><td class="">-</td><td class="text-right total">' + parseFloat(paymentCheque).toFixed(2) + '</td><td class="">'+paymentChequeNum+'</td><td>'+paymentReceiptNum+'</td><td>'+paymentchequeDate+'</td><td>'+paymentBank+'</td><td class="d-none">'+paymentBankID+'</td><td class="d-none">2</td></tr>');
                } else{
                    $('#tblPaymentTypeModal > tbody:last').append('<tr><td>Bank / Cheque</td><td class="">-</td><td class="text-right total">' + parseFloat(paymentCheque2).toFixed(2) + '</td><td class="">-</td><td>'+refferenceNum+'</td><td>'+paymentchequeDate2+'</td><td>'+paymentBank2+'</td><td class="d-none">'+paymentBankID2+'</td><td class="d-none">3</td></tr>');
                }
                ...
                $('#paymentCheque2').val('').prop('readonly', true);
                $('#refferenceNum').val('').prop('readonly', true);
                $('#paymentchequeDate2').val('').prop('readonly', true);
                $('#paymentBank2').val('').prop('disabled', true);
        ...
        $('#tblPaymentTypeModal').on('click', 'tr', function () {
            ...
            if (r == true) {
                ...
                $('#claimpayment').prop('checked', false);
        ...
        $('#btnIssueInv').click(function(){
            ...
            $.ajax({
                ...
                success: function(result) { //alert(result);
                    ...
                    // Clear the table and reset fields
                    $('#tblPaymentTypeModal tbody').empty();
                    $('#payAmount').text('');
                    $('#hidePayAmount').val('0');
                    $('#hideBalAmount').val('0');
                    $('#hideAllBalAmount').val('0');
                    $('#hidependingamount').val('0');
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                $.each(objfirst, function(i, item) {
                    ...
                    html += '" id="' + objfirst[i].invoiceid + '">' + objfirst[i].displayedInvoice + '<div>' + parseFloat(objfirst[i].invoicetotal).toFixed(2) + '</div></li>';
                });
    ...
    function updateTotals() {
        ...
        var paymentPayAmount = parseFloat($('#hideAllBalAmount').val());
        var balance = paymentPayAmount - sum;

        $('#hideBalAmount').val(balance);hideBalAmount
        $('#balanceAmount').html(balance.toFixed(2));
        $('#payAmount').html(sum.toFixed(2));
        $('#hidePayAmount').val(sum);
    }

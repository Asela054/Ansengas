            ...
            "columns": [
                ...
                },
                {
                    ...
                    render: function (data, type, full) {
                        ...
                        switch (data) {
                            case 0:
                                return '<span class=" bg-warning text-dark px-3 py-2">Pending</span>';
                            case 1:
                                return '<span class=" bg-success px-3 py-2">Approved</span>';
                            default:
                                return '<span class=" bg-secondary px-3 py-2">Unknown</span>';
                        }
                    }
                },
                {

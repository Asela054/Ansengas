...
$sql = "SELECT .`idtbl_customer`, .`name` FROM `tbl_customer`  INNER JOIN `tbl_customer_product_special` cs ON .`idtbl_customer` = cs.`tbl_customer_idtbl_customer` WHERE .`status` = 1 GROUP BY .`idtbl_customer`, .`name` ORDER BY .`name` ASC";
                    ...
                    <div class="card-body p-0 p-2">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 text-right">
                                <button class="btn btn-primary btn-sm" id="btnIssueReimbursement" disabled><i
                                        class="fas fa-plus"></i>&nbsp;Create Reimbursement</button>

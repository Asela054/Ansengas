        ...
        $('#dataTable').DataTable( {
            ...
            "columns": [
                ...
                },
                {
                    ...
                    button += '<a href="process/printtrustconfirmation.php?record=' + full['idtbl_trust_confirmation'] + '" target="_blank" data-toggle="tooltip" data-placement="bottom" title="Print " class="btn btn-outline-secondary btn-sm mr-1 ';
                    if (editcheck != 1) {
                        button += 'd-none';
                    }

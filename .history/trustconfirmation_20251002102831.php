        ...
        $('#dataTable').DataTable( {
            ...
            "columns": [
                ...
                },
                {
                    ...
                    button += '<a href="process/statustrustconfirmation.php?record=' + full['idtbl_trust_confirmation'] + '&type=3" target="_blank" data-toggle="tooltip" data-placement="bottom" title="Print PO" class="btn btn-danger btn-sm mr-1 ';
                    if (editcheck != 1) {
                        button += 'd-none';
                    }

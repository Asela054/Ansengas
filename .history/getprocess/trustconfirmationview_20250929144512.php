...
<div class="row">
    <div class="col-6 small">
        ...
        <label class="small font-weight-bold text-dark mb-1">Trust Confirmation No:</label> '.'TC-'.$purchase_data['idtbl_trust_confirmation'].'<br>
        <label class="small font-weight-bold text-dark mb-1">Customer:</label> '.$purchase_data['customer_name'].'<br>
        <label class="small font-weight-bold text-dark mb-1">Reference:</label> '.($purchase_data['employee_name'] ?? 'N/A').'
    </div>
    <div class="col-6 small">

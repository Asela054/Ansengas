...
$sql = "SELECT i.idtbl_invoice, i.date, i.tax_invoice_num, i.non_tax_invoice_num, c.idtbl_customer, c.name as customer_name, p.idtbl_product, p.product_name, id.newqty, id.refillqty,
            id.emptyqty,
            id.trustqty,
            id.trustreturnqty,
            id.discount_price,

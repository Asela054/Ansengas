...
$sql="SELECT * FROM `tbl_customer_discount` LEFT JOIN `tbl_customer` ON `tbl_customer`.`idtbl_customer`=`tbl_customer_discount`. WHERE `idtbl_customer_discount`='$record'";

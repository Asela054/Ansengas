...
$sql_details = "SELECT `d`.*, `p`.`product_name`, `p`.`product_code` 
                FROM `tbl_trust_confirmationdetail` AS `d` 
...
<div class="row">
    <div class="col-6 small">
        ...
        <label class="small font-weight-bold text-dark mb-1">Local Purchase No:</label> '.'LP-'.$purchase_data['idtbl_trust_confirmation'].'<br>

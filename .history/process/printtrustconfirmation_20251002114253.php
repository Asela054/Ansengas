...
<tr>
  ...
  <td style="border-left: none; border-right: 1px solid #000; padding: 0; width: 25%;">
    <table style="border-collapse: collapse; width: 100%;">
      <tr>
        <td style="border: 1px solid #000; border-left: none; padding: 4px; height: 40px;">DSE / CSE Name</td>
        <td style="border: none;"></td>
      </tr>
      <tr>
        <td style="border: 1px solid #000; border-left: none; padding: 4px; height: 40px;">RSM / ASM Name</td>
        <td style="border: none;"></td>
      </tr>
      <tr>
        <td style="border: 1px solid #000; border-left: none; padding: 4px; height: 40px;">FSM Name</td>
        <td style="border: none;"></td>
      </tr>
    </table>
  </td>
  ...
  <td style="border-left: none; padding: 0; width: 50%;">
    <table style="border-collapse: collapse; width: 100%;">
      <tr>
        <td style="border: 1px solid #000; border-left: none; padding: 4px; height: 40px;"></td>
      </tr>
      <tr>
        <td style="border: 1px solid #000; border-left: none; padding: 4px; height: 40px;"></td>
      </tr>

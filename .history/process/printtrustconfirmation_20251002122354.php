...
<tr>
  ...
  <!-- First row: LAUGFS -->
  <tr>
    <td rowspan="5" style="border: 1px solid #000; border-right: none; font-weight: bold; width: 25%; padding: 3px; vertical-align: top;">
      04 Details of Trust Cylinders-Info.
    </td>
    <td style="border: 1px solid #000; padding: 3px; height: 18px; text-align: center;">LAUGFS</td>
    <td style="border: 1px solid #000; border-left: none; padding: 3px; height: 18px;"></td>
    <td style="border: 1px solid #000; border-left: none; padding: 3px; height: 18px;"></td>
    <td style="border: 1px solid #000; border-left: none; padding: 3px; height: 18px;"></td>
  </tr>
  ...
  <tr>
    ...
    <td style="border: 1px solid #000; border-left: none; padding: 3px; height: 18px; text-align: center;">12.5</td>
    <td style="border: 1px solid #000; border-left: none; padding: 3px; height: 18px; text-align: center;">37.5</td>
    <td style="border: 1px solid #000; border-left: none; padding: 3px; height: 18px;"></td>
  </tr>

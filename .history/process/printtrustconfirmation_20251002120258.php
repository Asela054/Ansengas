...
<tr>
  ...
  <!-- 3rd Column -->
    ...
    <table style="width:100%; border-collapse: collapse;">
        <tr>
        <td style="width:25%; border:none; padding:0; text-align:left;">Commercial</td>
        <td style="width:25%; border:none; padding:0; text-align:left;">Dealer</td>
        <td style="width:25%; border:none; padding:0; text-align:left;">Distributor</td>
        <td style="width:25%; border:none; padding:0; text-align:left;">Other</td>
        </tr>
    </table>
    </td>
</tr>

...
try {
    ...
    foreach ($orderDetails as $detail) {
        ...
        $insertDetailQuery = "INSERT INTO `tbl_trust_confirmation_detail`(`idtbl_trust_confirmation_detail`, `qty`, `comment`, `status`, `updatedatetime`, `tbl_trust_confirmation_idtbl_trust_confirmation`, `tbl_product_idtbl_product`) 

...
<tr>
  ...
  <td colspan="2" style="border: 1px solid #000; padding: 6px; vertical-align: top;">
    <!-- Paragraph -->
    <p style="margin:0 0 8px 0; height:120px;">
    ...
    <!-- Signature table with middle border, centered content -->
    <table style="border-collapse: collapse; width: 100%; height: 120px; margin-top: 6px;">
      <tr>
        <!-- Signature of Customer -->
        <td style="width: 50%; border-right: 1px solid #000; vertical-align: middle; padding: 10px;">
          <div style="display: flex; flex-direction: column; justify-content: center; height: 100%;">
            <!-- Signature text -->
            <span style="margin-bottom: 10px;">Signature of the Customer</span>
            <!-- Seal -->
            <span style="margin-bottom: 10px;">Company Seal</span>
            <!-- Date aligned right with dots -->
            <span style="text-align: right;">..................................<br>Date: ............................</span>
          </div>
        </td>
        ...
        <td style="width: 50%; vertical-align: middle; padding: 10px;">
          <div style="display: flex; flex-direction: column; justify-content: center; height: 100%;">
            <!-- Signature text -->
            <span style="margin-bottom: 10px;">Signature of the Distributor</span>
            <!-- Seal -->
            <span style="margin-bottom: 10px;">Company Seal</span>
            <!-- Date aligned right with dots -->
            <span style="text-align: right;">..................................<br>Date: ............................</span>

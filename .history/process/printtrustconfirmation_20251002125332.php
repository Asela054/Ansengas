...
<tr>
  <td colspan="3" style="border: 1px solid #000; padding: 0;">
    <table style="width: 100%; border-collapse: collapse;">
      <!-- First row: LAUGFS wider, ends at 37.5 equivalent column -->
      <tr>
        ...
        <td style="border: 1px solid #000; padding: 3px; height: 18px; text-align: center; width: 75%;">LAUGFS</td>
        <td style="border: 1px solid #000; padding: 3px; height: 18px; width: 5%;"></td>
      </tr>

      <!-- Second row: four equal-width columns (match LAUGFS row end) -->
      <tr>
        <td style="border: 1px solid #000; padding: 3px; height: 18px; width: 12.5%;"></td>
        <td style="border: 1px solid #000; padding: 3px; height: 18px; width: 12.5%; text-align: center;">12.5</td>
        <td style="border: 1px solid #000; padding: 3px; height: 18px; width: 37.5%; text-align: center;">37.5</td>
        <td style="border: 1px solid #000; padding: 3px; height: 18px; width: 37.5%;"></td>
      </tr>

      <!-- Third row: equal widths -->
      <tr>

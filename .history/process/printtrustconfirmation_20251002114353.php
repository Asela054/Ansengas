...
<tr>
  ...
  <!-- 2nd Column -->
  <td style="border-top: 1px solid #000; border-bottom: 1px solid #000; border-left: none; border-right: 1px solid #000; padding: 6px; height: 40px;">
    DSE / CSE Name
  </td>
  
  <!-- 3rd Column -->
  <td style="border: 1px solid #000; border-left: none; padding: 6px; height: 40px;">
    <!-- Empty cell matching 2nd column height -->
  </td>
</tr>

<tr>
  <td style="border: 1px solid #000; border-right: none; font-weight: bold; width: 25%; padding: 6px;"></td>

...
$commercial_checked = $customer_type == 1 ? '<b>✓</b>' : '✓'; // 1 = Commercial
$dealer_checked = $customer_type == 2 ? '<b>✓</b>' : '✓'; // 2 = Dealer
$distributor_checked = $customer_type == 3 ? '<b>✓</b>' : '✓'; // 3 = Distributor
$other_checked = (!in_array($customer_type, [1, 2, 3])) ? '<b>✓</b>' : '✓'; // Other types

...
<tr>
  <td rowspan="5" style="border: 1px solid #000; border-right: none; font-weight: bold; width: 25%; padding: 3px;">
    04 Details of Trust Cylinders-Info.
  </td>
  
  <td style="border-top: 1px solid #000; border-bottom: 1px solid #000; border-left: 1px solid #000; border-right: 1px solid #000; padding: 3px; height: 18px;">
    LAUGHS
  </td>
    <td style="border: 1px solid #000; border-left: none; padding: 3px; height: 18px;">
    </td>
...
<tr>
  ...
  <td style="border: 1px solid #000; border-left: none; padding: 3px; height: 18px;">12.5
  </td>
<td style="border: 1px solid #000; border-left: none; padding: 3px; height: 18px;">37.5
  </td>
    <td style="border: 1px solid #000; border-left: none; padding: 3px; height: 18px;">
  </td>
</tr>

...
try {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        if ($stockRow = $stockResult->fetch_assoc()) {
            ...
            // Update stock: add empty qty to existing empty qty
            ...
            $insertStockSql = "INSERT INTO tbl_stock (emptyqty, status, updatedatetime, tbl_user_idtbl_user, tbl_product_idtbl_product)
                VALUES ('$emptyQty', '1', '$updatedatetime', '$userID', '$productId')";

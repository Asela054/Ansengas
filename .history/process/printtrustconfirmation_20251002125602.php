...
<tr>
  <td colspan="3" style="border: 1px solid #000; padding: 0;">
    <table style="width: 100%; border-collapse: collapse;">
      <!-- First row: LAUGFS spans first three columns of second row -->
      <tr>
        ...
        <!-- LAUGFS spans up to the end of 37.5 column -->
        <td style="border: 1px solid #000; padding: 3px; height: 18px; text-align: center; width: 62.5%;">LAUGFS</td>
        <!-- Small empty column after LAUGFS -->

...
<tr>
  <td colspan="3" style="border: 1px solid #000; padding: 0;">
    <table style="width: 100%; border-collapse: collapse;">
      <!-- First row -->
      <tr>
        <td rowspan="5" style="border: 1px solid #000; font-weight: bold; width: 40%; padding: 3px; vertical-align: middle;">
          05 Details of Trust Cylinders-Info.
        </td>
        <td style="border: 1px solid #000; padding: 3px; height: 18px; text-align: center; width: 60%;">LAUGFS</td>
        <td style="border: 1px solid #000; padding: 3px; height: 18px; width: 15%;"></td>
      </tr>

      <!-- Second row with 4 columns -->
      <tr>
        <td style="border: 1px solid #000; padding: 3px; height: 18px; width: 15%;"></td>
        <td style="border: 1px solid #000; padding: 3px; height: 18px; text-align: center; width: 7.5%;">12.5</td>
        <td style="border: 1px solid #000; padding: 3px; height: 18px; text-align: center; width: 7.5%;">37.5</td>
        <td style="border: 1px solid #000; padding: 3px; height: 18px; width: 15%;"></td>
      </tr>

      <!-- Third row -->
      <tr>
        <td style="border: 1px solid #000; padding: 3px; height: 18px; text-align: center; width: 15%;">Stock – Cylinders on Trust</td>
        <td style="border: 1px solid #000; padding: 3px; height: 18px; width: 7.5%;"></td>
        <td style="border: 1px solid #000; padding: 3px; height: 18px; width: 7.5%;"></td>
        <td style="border: 1px solid #000; padding: 3px; height: 18px; width: 15%;"></td>
      </tr>

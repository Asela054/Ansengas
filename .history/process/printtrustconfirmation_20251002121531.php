...
<table style="border-collapse: collapse; width: 100%; border: 1px solid #000;">
  <!-- First row: 05 Details of Trust cylinders-Info -->
  <tr>
    <td style="border: 1px solid #000; font-weight: bold; padding: 6px; vertical-align: top;">
      05 Details of Trust cylinders-Info.
    </td>
    <td colspan="3" style="border: 1px solid #000; padding: 0;">
      <table style="border-collapse: collapse; width: 100%;">
        <tr>
          <td style="border: 1px solid #000; text-align: center; padding: 4px;">LAUGFS</td>
  ...
  <!-- Second row: Stock – Cylinders on Trust -->
  <tr>
    <td style="border: 1px solid #000; font-weight: bold; padding: 6px; vertical-align: top;">
  ...
  <!-- Paragraph row related to 05 Details of Trust cylinders-Info -->
  <tr>

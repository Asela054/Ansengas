...
<tr>
  ...
  <td colspan="2" style="border: 1px solid #000; padding: 0;">
    <table style="border-collapse: collapse; width: 100%;">
      <tr>
        <td style="border: 1px solid #000; text-align: center; padding: 4px; width:33%;">Stock – Cylinders on Trust</td>
        <td style="border: 1px solid #000; text-align: center; padding: 4px; width:33%;">12.5</td>
        <td style="border: 1px solid #000; text-align: center; padding: 4px; width:34%;">37.5</td>
      </tr>
      <tr>
...
<tr>
  <!-- First column -->
  <td rowspan="5" style="border: 1px solid #000; border-right: none; font-weight: bold; padding: 6px; vertical-align: top;">
    05 Details of Trust cylinders-Info.
  </td>

  <!-- Second & third columns merged -->
  <td colspan="2" style="border: 1px solid #000; padding: 6px; height:160px; vertical-align: top;">

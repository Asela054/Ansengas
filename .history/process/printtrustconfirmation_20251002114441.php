...
<tr>
  <!-- 1st Column: single cell spanning all sub-rows -->
  <td rowspan="3" style="border: 1px solid #000; border-right: none; font-weight: bold; width: 25%; padding: 6px;">
    02 Sales Employee
  </td>
...
<tr>
  ...
  <td style="border: 1px solid #000; border-left: none; padding: 6px; height: 40px;"></td>
</tr>

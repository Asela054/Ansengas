...
<tr>
  ...
  <td style="border-top: 1px solid #000; border-bottom: 1px solid #000; border-left: none; border-right: 1px solid #000; padding: 3px; height: 18px;">
    ...
    <table style="width:100%; border-collapse: collapse;">
        ...
        <td style="width:30%; border:none; padding:0; text-align:left;">Dealer</td>
        <td style="width:30%; border:none; padding:0; text-align:left;">Distributor</td>
        <td style="width:30%; border:none; padding:0; text-align:left;">Other</td>
        </tr>
    </table>
    </td>
</tr>

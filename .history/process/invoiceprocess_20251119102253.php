...
if($vat_status==1){
    $insertinvoice="INSERT INTO `tbl_invoice`(`tax_invoice_num`,`non_tax_invoice_num`,`freeissue_status`,`date`, `total`, `taxamount`, `nettotal`, `paymentmethod`, `paymentcomplete`, `chequesend`, `companydiffsend`, `ref_id`, `vat`, `status`, `updatedatetime`, `tbl_user_idtbl_user`, `tbl_area_idtbl_area`, `tbl_customer_idtbl_customer`, `tbl_vehicle_load_idtbl_vehicle_load`) VALUES ('$nextTaxInvoiceNum','$invoiceNo','$invoiceNo','$invoicedate','$withouttaxtotal','$taxamount','$nettotal','0','0','0','0','$refID','$vatamount','1','$updatedatetime','$userID','$areaID','$customerID','$vehicleloadID')";
}else{
    $insertinvoice="INSERT INTO `tbl_invoice`(`non_tax_invoice_num`,`freeissue_status`,`date`, `total`, `taxamount`, `nettotal`, `paymentmethod`, `paymentcomplete`, `chequesend`, `companydiffsend`, `ref_id`, `vat`, `status`, `updatedatetime`, `tbl_user_idtbl_user`, `tbl_area_idtbl_area`, `tbl_customer_idtbl_customer`, `tbl_vehicle_load_idtbl_vehicle_load`) VALUES ('$invoiceNo','$invoiceNo','$invoicedate','$withouttaxtotal','$taxamount','$nettotal','0','0','0','0','$refID','$vatamount','1','$updatedatetime','$userID','$areaID','$customerID','$vehicleloadID')";
}
...
if($conn->query($insertinvoice)==true){
    ...
    foreach ($orderDetails as $detail) {
        ...
        $totqty=$newQty+$refillQty+$trustQty+$trustreturnQty;

        if ($totqty > 0) {
            $updatestock="UPDATE `tbl_vehicle_load_detail` SET `qty`=(`qty`- '$newQty' - '$refillQty'- '$trustQty'), `emptyqty` = (`emptyqty` + '$refillQty'  + '$trustreturnQty' - '$emptyQty') WHERE `tbl_product_idtbl_product`='$product' AND `tbl_vehicle_load_idtbl_vehicle_load`='$vehicleloadID'";

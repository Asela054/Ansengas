...
<tr>
  <td style="border: 1px solid #000; border-right: none; font-weight: bold; width: 25%; padding: 6px;">02 Sales Employee</td>
  
  <!-- 2nd Column -->
  <td style="border-left: none; border-right: 1px solid #000; padding: 0; width: 25%;">
    <table style="border-collapse: collapse; width: 100%;">
      <tr>
        <td style="border: 1px solid #000; border-left: none; padding: 4px;">DSE / CSE Name</td>
      </tr>
      <tr>
        <td style="border: 1px solid #000; border-left: none; padding: 4px;">RSM / ASM Name</td>
      </tr>
      <tr>
        <td style="border: 1px solid #000; border-left: none; padding: 4px;">FSM Name</td>
      </tr>
    </table>
  </td>
  
  <!-- 3rd Column -->
  <td style="border-left: none; padding: 0; width: 50%;">
    <table style="border-collapse: collapse; width: 100%;">
      <tr>
        <td style="border: 1px solid #000; padding: 4px;">Third Column Row 1</td>
      </tr>
      <tr>
        <td style="border: 1px solid #000; padding: 4px;">Third Column Row 2</td>
      </tr>
      <tr>
        <td style="border: 1px solid #000; padding: 4px;">Third Column Row 3</td>
      </tr>
    </table>
  </td>
</tr>
...
<tr>
  <td style="border: 1px solid #000; border-right: none; font-weight: bold; width: 25%; padding: 6px;">03 Distribution</td>
  <td style="border-top: 1px solid #000; border-bottom: 1px solid #000; border-left: none; border-right: 1px solid #000; width: 25%; padding: 6px;">
    Distributor Name: ANSEN Gas Distributors (Pvt) Ltd<br><br>
    Direct Operation:<br><br>
    Type: Commercial ☐ &nbsp; Dealer ☐ &nbsp; Distributor ☐ &nbsp; Other ☐
  </td>
  <td style="border: 1px solid #000; width: 50%; padding: 6px;"></td>
</tr>

<tr>
  <td style="border: 1px solid #000; border-right: none; font-weight: bold; width: 25%; padding: 6px;">04 Customer</td>
  <td style="border-top: 1px solid #000; border-bottom: 1px solid #000; border-left: none; border-right: 1px solid #000; width: 25%; padding: 6px;">
    Customer Code:<br><br>
    Customer Name:<br><br>
    Owner / Manager:<br><br>

...
<body style="margin: 0; padding: 0;">
    ...
    <table style="border-collapse: collapse; width: 100%; border: 2px solid #000;">
        <tr>
            <td colspan="3" style="text-align: center; padding: 8px; border: 1px solid #000; background-color: #f0f0f0;" class="header-font">
                LAUGFS Gas PLC <br>
        ...
        <tr>
            <td style="border: 1px solid #000; border-right: none; width: 25%; padding: 6px;" class="title-font">01 Date
            </td>
            <td style="border-top: 1px solid #000; border-bottom: 1px solid #000; border-left: none; border-right: none; width: 25%; padding: 6px;" class="data-font">
                ' . $date . '
            </td>
        ...
        <tr>
            <td rowspan="3" style="border: 1px solid #000; border-right: none; width: 25%; padding: 3px;" class="title-font">
                02 Sales Employee
            </td>
            <td style="border-top: 1px solid #000; border-bottom: 1px solid #000; border-left: none; border-right: 1px solid #000; padding: 3px; height: 18px;" class="title-font">
                DSE / CSE Name
            </td>
            <td style="border: 1px solid #000; border-left: none; padding: 3px; height: 18px;" class="data-font">
        ...
        <tr>
            <td rowspan="2" style="border: 1px solid #000; border-right: none; width: 25%; padding: 3px;" class="title-font">
                03 Distribution
            </td>
            <td style="border-top: 1px solid #000; border-bottom: 1px solid #000; border-left: none; border-right: 1px solid #000; padding: 3px; height: 18px;" class="title-font">
                Distributor Name
        ...
        <tr>
            <td rowspan="7" style="border: 1px solid #000; border-right: none; width: 25%; padding: 3px;" class="title-font">
                04 Customer
            </td>
            <td style="border-top: 1px solid #000; border-bottom: 1px solid #000; border-left: none; border-right: 1px solid #000; padding: 3px; height: 18px;" class="title-font">
                Type:
            ...
            <td style="border: 1px solid #000; border-left: none; padding: 3px; height: 18px;" class="data-font">
                <table style="width:100%; border-collapse: collapse;">
                    <tr>
                        ...
                        <td style="width:25%; border:none; padding:0; text-align:center;">Distributor &nbsp;' . $distributor_checked . ' </td>
                        <td style="width:25%; border:none; padding:0; text-align:center;">Other &nbsp;' . $other_checked . ' </td>
                    </tr>
                </table>
            </td>
        </tr>
        ...
        <tr>
            <td colspan="3" style="border: 1px solid #000; padding: 0;">
                <table style="width: 100%; border-collapse: collapse;">
                    <tr>
                        <td rowspan="5" style="border: 1px solid #000; width: 18.5%; padding: 3px; vertical-align: middle;" class="title-font">
                            05 Details of Trust Cylinders-Info.
                        </td>
                        <td colspan="3" style="border: 1px solid #000; padding: 3px 50px 3px 3px; height: 18px; text-align: right; width: 40%;" class="title-font">
                            LAUGFS</td>
                    ...
                    <tr>
                        ...
                        <td style="border: 1px solid #000; padding: 3px; height: 18px; text-align: center; width: 12.5%;" class="title-font">
                            12.5</td>
                        <td style="border: 1px solid #000; padding: 3px; height: 18px; text-align: center; width: 12.5%;" class="title-font">
                            37.5</td>
                        <td style="border: 1px solid #000; padding: 3px; height: 18px; width: 25%;"></td>
                    ...
                    <tr>
                        <td style="border: 1px solid #000; padding: 3px; height: 18px; text-align: center; width: 25%;" class="title-font">
                            Stock – Cylinders on Trust</td>
                        <td style="border: 1px solid #000; padding: 3px; height: 18px; width: 12.5%; text-align: center;" class="data-font">
                            ' . $stock_12_5 . '</td>
                        <td style="border: 1px solid #000; padding: 3px; height: 18px; width: 12.5%; text-align: center;" class="data-font">
                            ' . $stock_37_5 . '</td>
                        <td style="border: 1px solid #000; padding: 3px; height: 18px; width: 25%;"></td>
                    ...
                    <tr>
                        <td colspan="4" style="border: 1px solid #000; padding: 6px; vertical-align: top; height: 160px;" class="data-font">
        ...
        <tr>
            <td style="border: 1px solid #000; border-right: none; padding: 6px; vertical-align: top;" class="title-font">
                06 Trust Cylinders confirmation
            </td>
            <td colspan="2" style="border: 1px solid #000; padding: 6px; vertical-align: top;">
                <p style="margin:0 0 15px 0; height: 50px; vertical-align: top;" class="data-font">
                    ...
                    <tr>
                        ...
                        <td style="padding: 8px; width: 50%; border-right: 1px solid #000; vertical-align: top;">
                            <div style="margin-bottom: 25px;">
                                ...
                                <div class="title-font">Signature of the Customer</div>
                            </div>
                            <div style="display: flex; justify-content: space-between; align-items: flex-end;">
                                <div style="flex: 1; margin-right: 15px;">
                                    <div style="padding-top: 10px; margin-top: 10px;"></div>
                                    <div class="title-font">Company Seal</div>
                                </div>
                                <div style="text-align: right;">
                                    <div style="padding-bottom: 4px; margin-bottom: 4px; width: 100px;"></div>
                                    <div style="border-top: 1px dotted #000; width: 50%; margin-left: auto;" class="title-font">Date</div>
                                </div>
                            </div>
                        </td>
                        ...
                        <td style="padding: 8px; width: 50%; vertical-align: top;">
                            <div style="margin-bottom: 25px;">
                                ...
                                <div class="title-font">Signature of the Distributor</div>
                            </div>
                            <div style="display: flex; justify-content: space-between; align-items: flex-end;">
                                <div style="flex: 1; margin-right: 15px;">
                                    <div style="padding-top: 10px; margin-top: 10px;"></div>
        ...
        <tr>
            ...
            <td style="border: 1px solid #000; height: 0px; padding: 6px; width: 50%; vertical-align: bottom;">
                <div class="title-font">AUTHORIZED BY</div><br><br>
                <table style="border-collapse: collapse; width: 100%;">
                    <tr>
                        <td style="width: 50%; vertical-align: top;" class="title-font">................................... ASM:</td>
                        <td style="width: 50%; vertical-align: top;" class="title-font">................................... FSM:</td>
                    </tr>
                </table>
            </td>
            <td style="border: 1px solid #000; height: 120px; padding: 6px; width: 50%; vertical-align: bottom;">
                <table style="border-collapse: collapse; width: 100%;">
                    <tr>
                        <td style="width: 50%; vertical-align: top;" class="title-font">.................................... Authorized
                            Signatory (Auditor)</td>
                        <td style="width: 50%; vertical-align: top;" class="title-font">.................................... Date</td>
                    </tr>
                </table>
            </td>
        </tr>

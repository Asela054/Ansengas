  ...
  <td colspan="2" style="border: 1px solid #000; padding: 6px; vertical-align: top;">
    ...
    <table style="border-collapse: collapse; width: 100%; margin-top: 10px;">
      ...
      <div style="margin-bottom: 25px;">
        <div style="border-bottom: 1px dotted #000; width: 100%; padding-bottom: 4px; margin-bottom: 4px;"></div>
      ...
      <div style="display: flex; justify-content: space-between; align-items: flex-end;">
        ...
        <div style="text-align: right;">
          <div style="border-bottom: 1px dotted #000; width: 100px; padding-bottom: 4px; margin-bottom: 4px;"></div>
          <div>Date</div>
        </div>
      </div>
    </td>

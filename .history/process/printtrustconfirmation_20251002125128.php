  ...
  <td colspan="3" style="border: 1px solid #000; padding: 0;">
    <table style="width: 100%; border-collapse: collapse;">
      ...
      <tr>
        ...
        <td style="border: 1px solid #000; padding: 3px; height: 18px; width: 25%; text-align: center;">12.5</td>
        <td style="border: 1px solid #000; padding: 3px; height: 18px; width: 25%; text-align: center;">37.5</td>
        <td style="border: 1px solid #000; padding: 3px; height: 18px; width: 25%;"></td>
      </tr>

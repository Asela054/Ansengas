...
try {
    ...
    $insertOrderQuery = "INSERT INTO `tbl_local_purchase` 
        (`idtbl_trust_confirmation`, `date`, `remark`, `status`, `insertdatetime`, `updateuser`, `updatedatetime`, `tbl_user_idtbl_user`, `tbl_employee_idtbl_employee`, `tbl_customer_idtbl_customer`) 

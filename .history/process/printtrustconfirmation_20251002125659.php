...
<tr>
  <td colspan="3" style="border: 1px solid #000; padding: 0;">
    <table style="width: 100%; border-collapse: collapse;">
      <!-- First row: LAUGFS ends at 37.5 column -->
      <tr>
        ...
        <!-- LAUGFS spans width up to 12.5 + 37.5 of second row -->
        <td style="border: 1px solid #000; border-right: none; padding: 3px; height: 18px; text-align: center; width: 50%;">LAUGFS</td>
        <!-- Small empty cell just to complete table -->
        <td style="border: 1px solid #000; padding: 3px; height: 18px; width: 20%;"></td>
      </tr>

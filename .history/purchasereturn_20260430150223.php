...
<script>
    $(document).ready(function() {
                    ...
                    success: function (data) {
                        ...
                        $.each(data, function (index, product) {
                            ...
                            tableBody.append('<tr class="' + categoryClass + '">' +
                                ...
                                '<td class="">' + product.idtbl_product + '</td>' +
                                '<td class="">0</td>' +
                                '<td class="">' + product.emptyprice + '</td>' +
                                '<td class="">' + product.refillprice + '</td>' +
                                '<td class="">' + emptyPriceWithVAT + '</td>' +
                                '<td class="">' + refillPriceWithVAT + '</td>' +
                                ...
                                '<td class=" hide-total-column"><input type="number" class="form-control form-control-sm custom-width" name="hidetotal_quantity[]" value="0"></td>' +
                                ...
                                '<td class=" hide-total-column-without-vat"><input type="number" class="form-control form-control-sm custom-width" name="hidetotal_quantity_without_VAT[]" value="0"></td>' +
                                '</tr>');
        ...
        function updateTotalForRow(row) {
            ...
            // Get prices from hidden columns (without VAT)
            var emptyPrice = parseFloat(row.find('td:eq(3)').text()) || 0;
            var refillPrice = parseFloat(row.find('td:eq(4)').text()) || 0;

            // Get prices with VAT for total calculation
            var emptyPriceWithVAT = parseFloat(row.find('td:eq(5)').text()) || 0;
            var refillPriceWithVAT = parseFloat(row.find('td:eq(6)').text()) || 0;
        ...
        $('#btncreateorder').click(function () {
            ...
            $('#tableBody tr').each(function () {
                ...
                var refillpricewithoutvat = $(this).find('td:eq(6)').text();

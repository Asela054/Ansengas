            ...
            $('#dataTable').DataTable({
                ...
                "columns": [{
                    ...
                    },
                    {
                        ...
                        "render": function (data, type, full) {
                            var button = '';
                            button += '<button class="btn btn-outline-dark btn-sm btnaddsalesrep mr-1" id="' + full['idtbl_customer'] + '" data-toggle="tooltip" data-placement="bottom" title="Add Salesrep"><i class="fas fa-plus"></i></button>';

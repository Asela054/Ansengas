...
$sqlproduct="SELECT `idtbl_product`, `product_name` FROM `tbl_product` WHERE `status`=1 AND `tbl_product_category_idtbl_product_category`=1 ORDER BY `orderlevel`";
                ...
                success: function (data) {
                    ...
                    $.each(data, function (index, product) {
                        ...
                        tableBody.append('<tr>' +
                            ...
                            '<td class="text-center"><textarea type="text" class="form-control form-control-sm custom-width" name="comment"></textarea></td>' +
                            '</tr>');
                    });

...
else if($lastElement=='lorrysaleinfo.php'){
...
else if($lastElement=='driversaleinfo.php'){
...
else if($lastElement=='alloverdue.php'){
...
else if($lastElement=='customertarget.php'){
...
else if($lastElement=='holidays.php'){
...
else if($lastElement=='rpt_summery_sale_qty.php'){
...
else if($lastElement=='porderrequest.php'){
...
else if($lastElement=='rpt_suppliertax.php'){
...
else if($lastElement=='rpt_customertax.php'){
...
else if($lastElement=='advancedpayment.php'){
...
else if($lastElement=='accountsexport.php'){
...
else if($lastElement=='customerdiscount.php'){
...
else if($lastElement=='invoicereimbursement.php'){
...
else if($lastElement=='rpt_trustbreakdown.php'){
...
else if($lastElement=='rptsalereportmonthly.php'){
...
else if($lastElement=='trustconfirmation.php'){
...
<nav class="sidenav shadow-right sidenav-light">
    <div class="sidenav-menu">
        <div class="nav accordion" id="accordionSidenav">
            ...
            <?php } if(menucheck($menuprivilegearray, 7)==1 | menucheck($menuprivilegearray, 82)==1){ ?>
            <a class="nav-link p-0 px-3 py-2 collapsed" href="javascript:void(0);" data-toggle="collapse" data-target="#collapseporder" aria-expanded="false" aria-controls="collapseporder">
                <div class="nav-link-icon"><i data-feather="archive"></i></div>
                Purchasing Order
                <div class="sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
            </a>
            <div class="collapse <?php if($lastElement=="porder.php" | $lastElement=="porderrequest.php"){echo 'show';} ?>" id="collapseporder" data-parent="#accordionSidenav">
                <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPages">
                    <?php if(menucheck($menuprivilegearray, 82)==1){ ?>
                    <a class="nav-link p-0 px-3 py-1" href="porderrequest.php">Purchasing Order Request</a>
                    <?php } if(menucheck($menuprivilegearray, 7)==1){ ?> 
                    <a class="nav-link p-0 px-3 py-1" href="porder.php">Purchasing Order</a>
                    <?php } ?>
                </nav>
            </div>
            ...
            <?php } if(menucheck($menuprivilegearray, 14)==1 | menucheck($menuprivilegearray, 15)==1 | menucheck($menuprivilegearray, 16)==1 | menucheck($menuprivilegearray, 26)==1 | menucheck($menuprivilegearray, 27)==1 | menucheck($menuprivilegearray, 86)==1 | menucheck($menuprivilegearray, 89)==1){ ?>
            ...
            <div class="collapse <?php if($lastElement=="invoice.php" | $lastElement=="invoicepayment.php" | $lastElement=="paymentreceipt.php" | $lastElement=="invoiceview.php" | $lastElement=="invoicerecovery.php" | $lastElement=="advancedpayment.php" | $lastElement=="invoicereimbursement.php"){echo 'show';} ?>" id="collapseorder" data-parent="#accordionSidenav">
                <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPages">
                    ...
                    <?php }if(menucheck($menuprivilegearray, 86)==1){ ?>
                        <a class="nav-link p-0 px-3 py-1" href="advancedpayment.php">Advanced Payment</a>
            ...
            <a class="nav-link p-0 px-3 py-2" href="trustconfirmation.php">
                <div class="nav-link-icon"><i class="fas fa-shopping-bag"></i></div>
                Trust 
            </a>
            ...
            <?php } if(menucheck($menuprivilegearray, 4)==1 | menucheck($menuprivilegearray, 44)==1 | menucheck($menuprivilegearray, 88)==1){ ?>
            ...
            <div class="collapse <?php if($lastElement=="customer.php" | $lastElement=="customerwiserep.php" | $lastElement=="customerdiscount.php"){echo 'show';} ?>" id="collapsecustomer" data-parent="#accordionSidenav">
                <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPages">
                    <?php if(menucheck($menuprivilegearray, 9)==1){ ?> 
                    ...
                    <a class="nav-link p-0 px-3 py-1" href="customerdiscount.php">Customerwise Discount</a>
                    <?php } ?>
                </nav>
            </div>
            ...
            <?php } if(menucheck($menuprivilegearray, 23)==1 | menucheck($menuprivilegearray, 24)==1 | menucheck($menuprivilegearray, 38)==1 | menucheck($menuprivilegearray, 69)==1){ ?>
            ...
            <div class="collapse <?php if($lastElement=="employeetargetadd.php" | $lastElement=="vehicletargetadd.php" | $lastElement=="areatarget.php"  |  $lastElement=="customertarget.php"){echo 'show';} ?>" id="collapsetarget" data-parent="#accordionSidenav">
                <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPages">
                    ...
                    <a class="nav-link p-0 px-3 py-1" href="customertarget.php">Customer Target</a>
                    <?php } ?>
                </nav>
            </div>
            ...
            <?php } if(menucheck($menuprivilegearray, 11)==1 | menucheck($menuprivilegearray, 12)==1 | menucheck($menuprivilegearray, 13)==1 | menucheck($menuprivilegearray, 39)==1 | menucheck($menuprivilegearray, 40)==1 | menucheck($menuprivilegearray, 70)==1 | menucheck($menuprivilegearray, 94)==1){ ?>
            ...
            <div class="collapse <?php if($lastElement=="vehicle.php" | $lastElement=="employee.php" | $lastElement=="area.php" | $lastElement=="mainarea.php" | $lastElement=="vatinfo.php" | $lastElement=="holidays.php" | $lastElement=="groupcategory.php"){echo 'show';} ?>" id="collapseother" data-parent="#accordionSidenav">
                <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPages">
                    ...
                    <a class="nav-link p-0 px-3 py-1" href="holidays.php">Holidays</a>
            ...
            <div class="collapse <?php if($lastElement=="stock.php" | $lastElement=="employeetarget.php" | $lastElement=="vehicletarget.php" | $lastElement=="customeroutstanding.php" | $lastElement=="dailysale.php" | $lastElement=="refsaleinfo.php" | $lastElement=="dailycash.php" | $lastElement=="salereportcustomer.php" | $lastElement=="salereportproduct.php" | $lastElement=="bufferstockmaintainreport.php" | $lastElement=="lorrysaleinfo.php" | $lastElement=="driversaleinfo.php" | $lastElement=="rpt_summery_sale_qty.php" | $lastElement=="rpt_suppliertax.php" | $lastElement=="rpt_customertax.php" | $lastElement=="rpt_trustbreakdown.php" | $lastElement=="rptsalereportmonthly.php"){echo 'show';} ?>" id="collapsereport" data-parent="#accordionSidenav">
                <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPages">
                    ...
                    <a class="nav-link p-0 px-3 py-1" href="employeetarget.php">Target Report</a>
                    ...
                    <a class="nav-link p-0 px-3 py-1" href="rpt_summery_sale_qty.php">Sales Summary</a>
                    ...
                    <a class="nav-link p-0 px-3 py-1" href="alloverdue.php">All Over Due Info</a>
                    ...
                    <a class="nav-link p-0 px-3 py-1" href="lorrysaleinfo.php">Lorry Sale Info</a>
                    <?php }if(menucheck($menuprivilegearray, 67)==1){ ?>
                    <a class="nav-link p-0 px-3 py-1" href="driversaleinfo.php">Driver Sale Info</a>
                    ...
                    <a class="nav-link p-0 px-3 py-1" href="rpt_suppliertax.php">Supplier Tax Report</a>
            ...
            <a class="nav-link p-0 px-3 py-2" href="exportaccounts.php">
                <div class="nav-link-icon"><i class="far fa-file-excel"></i></div>
                Accounts Export
            </a>

                ...
                "columns": [{
                    ...
                    },
                    {
                        ...
                        "render": function (data, type, full) {
                            ...
                            if (full['type'] == 2) {
                                button += '<button class="btn btn-outline-dark btn-sm btnAddProductStock mr-1 ';
                                if (addcheck == 0) {
                                    button += 'd-none';
                                }
                                button += '" id="' + full['idtbl_customer'] + '"><i class="fas fa-warehouse"></i></button>';
                            }
                            if (full['type'] == 1 | full['type'] == 3) {
                                button += '<button class="btn btn-outline-purple btn-sm btnAddProduct mr-1 ';
                                if (addcheck == 0) {
                                    button += 'd-none';
                                }
                                button += '" id="' + full['idtbl_customer'] + '"><i class="fas fa-shopping-cart"></i></button>';
                            }
                            ...
                            if (full['status'] == 1 && statuscheck == 1) {
                                ...
                                button += '" id="' + full['idtbl_customer'] + '"><i class="fas fa-times-circle"></i></button>';
                            ...
                            if (deletecheck == 1) {
                                button += '<button type="button" data-url="process/statuscustomer.php?record=' + full['idtbl_customer'] + '&type=3" data-actiontype="3" class="btn btn-outline-danger btn-sm text-light btntableaction"><i class="fas fa-trash-alt"></i></button>';
                            }

            ...
            "columns": [
                ...
                },
                {
                    ...
                    "render": function(data, type, full) {
                        ...
                        // Check sendstatus value to determine button display
                        if (full['sendstatus'] == 1) {
                            button += '<a href="#" class="btn btn-outline-success btn-sm mr-1 disabled" aria-disabled="true" tabindex="-1"><i class="fas fa-paper-plane"></i></a>';
                        } else {
                            button += '<a href="process/updatestock.php?record=' + full['idtbl_credit_note'] + '" onclick="return update_confirm()" target="_self" class="btn btn-outline-success btn-sm mr-1 ';
                            if (statuscheck == 0) {
                                button += 'd-none';
                            }
                            button += '"><i class="fas fa-paper-plane"></i></a>';
                        }

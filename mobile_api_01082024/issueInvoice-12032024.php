...
if($vat_status==1){
    $insertinvoice="INSERT INTO `tbl_invoice`(`tax_invoice_num`,`date`, `total`, `taxamount`, `nettotal`, `paymentmethod`, `paymentcomplete`, `chequesend`, `companydiffsend`, `ref_id`, `status`, `updatedatetime`, `tbl_user_idtbl_user`, `tbl_area_idtbl_area`, `tbl_customer_idtbl_customer`, `tbl_vehicle_load_idtbl_vehicle_load`) VALUES ('$nextTaxInvoiceNum','$invoicedate','$withouttaxtotal','$taxamount','$nettotal','0','0','0','0','$refID','1','$updatedatetime','$refID','$areaID','$customerID','$vehicleloadID')";
}else{
    $insertinvoice="INSERT INTO `tbl_invoice`(`date`, `total`, `taxamount`, `nettotal`, `paymentmethod`, `paymentcomplete`, `chequesend`, `companydiffsend`, `ref_id`, `status`, `updatedatetime`, `tbl_user_idtbl_user`, `tbl_area_idtbl_area`, `tbl_customer_idtbl_customer`, `tbl_vehicle_load_idtbl_vehicle_load`) VALUES ('$invoicedate','$withouttaxtotal','$taxamount','$nettotal','0','0','0','0','$refID','1','$updatedatetime','$refID','$areaID','$customerID','$vehicleloadID')";
}

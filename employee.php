...
$sql="SELECT `idtbl_employee`, `name`, `dob`, `epfno`, `nic`, `phone`, `tbl_user_type_idtbl_user_type`, `status` FROM `tbl_employee` WHERE `status` IN (1,2)";
                            ...
                            <div class="col-3">
                                <form action="process/employeeprocess.php" method="post" autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control form-control-sm" name="user_account" id="user_account">

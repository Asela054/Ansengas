...
foreach($tableData as $rowtabledata){
    ...
    if($receipttype==3){
        ...
        $updatereceiptdetail="UPDATE `tbl_invoice` SET `addtoaccountstatus`='1',`protoaccountstatus`='1',`updatedatetime`='$updatedatetime',`tbl_user_idtbl_user`='$userID' WHERE `idtbl_invoice`='$receiptID'";
        ...
        $updatereceiptdetail="UPDATE `tbl_invoice_payment_detail` SET `addaccountstatus`='1',`protoaccountstatus`='1',`updatedatetime`='$updatedatetime',`tbl_user_idtbl_user`='$userID' WHERE `idtbl_invoice_payment_detail`='$receiptID'";
        $conn->query($updatereceiptdetail);
    }

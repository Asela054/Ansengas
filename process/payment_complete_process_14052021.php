	...
	*/
	if($stmt->num_rows>=2){
		...
		do{
			...
			$stmtInsert->bind_param('sssssssssssssssssss', $tbl_master_idtbl_master, $trano, $traid, $seqno, $acccode, $accamount, $crdr, $narration, $totamount, $tradate, $paytype, $receiptinvno, $refid, $status, $refno, $updatedatetime, $ismatched, $branchcode, $companycode, $tbl_user_idtbl_user);

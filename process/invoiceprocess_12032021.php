...
$insertinvoice="INSERT INTO `tbl_invoice`(`date`, `total`, `paymentmethod`, `paymentcomplete`, `chequesend`, `companydiffsend`, `ref_id`, `status`, `updatedatetime`, `tbl_user_idtbl_user`, `tbl_area_idtbl_area`, `tbl_customer_idtbl_customer`, `tbl_reject_reason_idtbl_reject_reason`, `tbl_vehicle_load_idtbl_vehicle_load`) VALUES ('$invoicedate','$nettotal','0','0','0','0','$refID','1','$updatedatetime','$userID','$areaID','$customerID','$rejectID','$vehicleloadID')";
if($conn->query($insertinvoice)==true){
    ...
    foreach($tableData as $rowtabledata){
        ...
        $cusfull=$rowtabledata['col_13'];
        $cusempty=$rowtabledata['col_14'];

        $insertinvoicedetail="INSERT INTO `tbl_invoice_detail`(`newqty`, `refillqty`, `returnqty`, `trustqty`, `unitprice`, `refillprice`, `newsaleprice`, `newrefillprice`, `cusfullqty`, `cusemptyqty`, `status`, `updatedatetime`, `tbl_user_idtbl_user`, `tbl_product_idtbl_product`, `tbl_invoice_idtbl_invoice`) VALUES ('$newqty','$refillqty','$returnqty','$trustqty','$unitprice','$refillprice','$newsaleprice','$refillsaleprice','$cusfull','$cusempty','1','$updatedatetime','$userID','$product','$invoiceID')";

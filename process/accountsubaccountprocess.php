...
$accountnumber=$mainclass.$subclass.$code;

if($recordOption==1){
    $insert="INSERT INTO `tbl_subaccount`(`mainclasscode`, `subclasscode`, `mainaccountcode`, `code`, `subaccount`, `subaccountname`, `status`, `updatedatetime`, `tbl_user_idtbl_user`, `tbl_account_category_idtbl_account_category`) VALUES ('$mainclass','$subclass','','$code','$accountnumber','$subaccount','1','$updatedatetime','$userID','$accountcategory')";

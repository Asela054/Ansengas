...
foreach ($orderDetails as $detail) {
    ...
    $refillprice = !empty($refillQty) || !empty($trustQty) || !empty($returnQty) || !empty($saftyQty) || !empty($saftyReturnQty) || !empty($emptyQty) ? $refillPrice : null;

    if ($newPrice !== null || $refillprice !== null) {

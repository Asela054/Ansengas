...
$insertOrderQuery = "INSERT INTO `tbl_porder`(`orderdate`, `nettotal`, `remark`, `confirmstatus`, `dispatchissue`, `grnissuestatus`, `status`, `updatedatetime`, `tbl_user_idtbl_user`) 
VALUES ('$orderDate', '$total', '$remark', '0', '0', '0', '1', '$updatedatetime', '$userID')";
...
foreach ($orderDetails as $detail) {
    ...
    if ($newPrice !== null || $refillprice !== null || $emptyPrice !== null) {
        $insertDetailQuery = "INSERT INTO tbl_porder_detail (`type`, `refillqty`, `emptyqty`, `returnqty`, `newqty`, `trustqty`, `saftyqty`, `saftyreturnqty`, `unitprice`, `refillprice`, `emptyprice`, `status`, `updatedatetime`, `tbl_user_idtbl_user`, `tbl_porder_idtbl_porder`, `tbl_product_idtbl_product`) 
                            VALUES ('0', '$refillQty', '$emptyQty', '$returnQty', '$newQty', '$trustQty', '$saftyQty', '$saftyReturnQty', '$newPrice', '$refillprice','$emptyPrice', '1', '$updatedatetime', '$userID', '$orderID', '$productId')";

...
foreach ($orderDetails as $detail) {
    ...
    if ($emptyPrice !== null || $emptyPricewithoutVat !== null) {
        $insertDetailQuery = "INSERT INTO tbl_credit_note_detail (`emptyqty`, `emptyprice_withoutvat`, `emptyprice`, `status`, `updatedatetime`, `tbl_user_idtbl_user`, `tbl_credit_note_idtbl_credit_note`, `tbl_product_idtbl_product`) 
        VALUES ('$emptyQty', '$emptyPricewithoutVat','$emptyPrice', '1', '$updatedatetime', '$userID', '$creditnoteID', '$productId')";

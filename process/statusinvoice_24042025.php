...
if($conn->query($sql)==true){
    ...
    while($rowcheckdetail = $resultcheckdetail-> fetch_assoc()){
        ...
        $updatestock="UPDATE `tbl_vehicle_load_detail` SET `qty`=(`qty`+'$totqty'), `emptyqty`=(emptyqty + '$emptyqty' - '$refillqty' + '$returnqty')  WHERE `tbl_product_idtbl_product`='$productID' AND `tbl_vehicle_load_idtbl_vehicle_load`='$vehicleloadID'";

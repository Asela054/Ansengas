...
if($conn->query($sql)==true){
    ...
    while($rowcheck = $resultcheck-> fetch_assoc()){
        ...
        $updateexcesspayment="UPDATE `tbl_invoice_excess_payment` SET `status`='$value',`updatedatetime`='$updatedatetime',`updateuser`='$userID' WHERE `tbl_invoice_payment_idtbl_invoice_payment`='$record'";

...
$tax_cus_address=$_POST['tax_cus_address'];
...
if($recordOption==1){
    $query = "INSERT INTO `tbl_customer`(`type`, `name`, `nic`, `phone`, `email`, `address`, `tax_cus_name`, `tax_cus_address`, `tax_num`, `vat_status`, `discount_status`, `vat_num`, `s_vat`, `numofvisitdays`, `creditlimit`, `credittype`, `creditperiod`, `emergencydate`, `specialcus_status`, `main_area`, `status`, `updatedatetime`, `tbl_user_idtbl_user`, `tbl_area_idtbl_area`) VALUES ('$cusType', '$cusName', '$cusNic', '$cusMobile', '$cusEmail', '$address', '$tax_cus_name', '$tax_cus_address', '$tax_num', '$vatStatus', '$discountedcustomer','$cusVatNum', '$cusSVat', '$cusNoVisit', '$cusCreditlimit','$cuscredittype','$cuscreditdays','', '$specialcustomer', '$specialarea', '1','$updatedatetime', '$userID', '$cusArea')";
